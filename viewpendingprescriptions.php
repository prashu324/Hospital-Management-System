<?php
	...
	$id=$_SESSION["puid"];
	$sql1="SELECT * from appointment where attended=1 and delivered=0 order by dateofappointment";
		...
		<div class="w3-container">
			...
			<table class="cnfappnt" border="2" style="border-style: solid 1px;width: 100%;">
				...
				<tr>
					...
					<td><a href="viewprescription1.php<?php echo '?aid='.$row1['aid']; ?>">View</a></td>
				</tr>
				<?php } ?>
			</table>
			<?php } ?>
