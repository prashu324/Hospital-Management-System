...
<body>
	...
	<div class="content">
		<h1 style="font-size: 36px;text-align: center;">Admin login</h1>
		<div class="form-content">
			<form action="" method="POST">
				<label><b>Admin user ID</b></label><br>
				<input type="text" name="aid" class="myinput" placeholder="Enter your user ID" required="" autofocus ><br>
				...
				<?php
					...
					if(isset($_POST["aid"])&&isset($_POST["pw"])){
						$id=$_POST["aid"];
						$_SESSION["aid"]=$id;
						$password=$_POST["pw"];
