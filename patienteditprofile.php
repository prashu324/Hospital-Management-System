	...
	<div style="margin-left:20%">
		...
		<?php
			if (isset($_POST["place"])) {
				...
				$mobile=$_POST["mobile"];
				$email=$_POST["emailid"];
				$sql2="UPDATE patient set place='$place', mobile='$mobile', email='$email' where pid='$id'";
				$result2=mysqli_query($conn,$sql2);
				if ($result2) {
					echo "<center><span style='color:green;'>Patient details updated</span></center>";
					header("refresh:5;url=patienteditprofile.php");
				}
			}
		?>
	</div>	
